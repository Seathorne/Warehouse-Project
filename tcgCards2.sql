...
INSERT INTO tcgCards2 (CardName, Category, Edition, SetNumber, SetId, SeriesId, SerialNumber,
                       Illustrator, PrintYear, Language, Rarity, CardEffect)
VALUES ('Kingdra', 'DELTA SPECIES Pokémon', 'Holo', 010, 35, 07, '6SP-RGE-DSR',
...
SET Type          = 'Fire',
    ...
    Attack1Cost   = 'Fire, Colorless',
    Attack2Cost   = 'Fire, Metal, Colorless x2',
    Attack1Damage = '30+',
    Attack2Damage = '80',
    Attack1Name   = 'Extra Flame',
    Attack2Name   = 'Heat Blast'
...
SELECT *
FROM tcgSets
WHERE SetName = 'Next Destinies'; -- 75//14
SELECT *
FROM tcgSets
WHERE SetName LIKE '%Holon Phantoms%';
